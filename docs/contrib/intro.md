...
The Energy Transition Model is built and maintained according to the following principles:
...
The ETSource boundary is a maintained interface. Robust, general methods belong in ETEngine rather than offloaded as complexity in ETSource. ETM experts are involved early when a change affects that boundary.
