...
Note that all of the direct emissions methods are only calculated for energy and molecule nodes that have the `direct_emissions` group specified. All emissions are calculated in `kg CO2eq`.
