 ...
 * Row 2-8761 should contain the hourly values (one for each hour per year). Read the documentation about [modifiable profiles](/main/profiles#uploading-custom-profiles) for more details on the value requirements per profile type.
