...
For all datasets the average temperature and full load hours of wind turbines and solar PV can be adjusted. For the Netherlands it is possible to select one of three weather years with extreme weather conditions to explore the effect of these conditions. On this page these features are explained.
