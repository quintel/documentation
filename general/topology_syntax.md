...
As we have seen in the [topology documentation page](https://github.com/quintel/documentation/general/topology.md), a network structure can be defined in YAML format:
